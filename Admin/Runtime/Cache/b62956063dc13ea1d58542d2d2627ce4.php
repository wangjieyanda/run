...
<form name="form1" action="__URL__/update" enctype="multipart/form-data" method="post" >
<input type="hidden" value="<?php echo ($data["arcid"]); ?>" name="arcid"/>
  <table width="98%"  border="0" align="center" cellpadding="2" cellspacing="2" id="needset" style="border:1px solid #cfcfcf;background:#ffffff;">
    <tr>
      <td height="24" colspan="5" class="bline">
          ...
          <tr>
            ...
            <td width='300' ><input name="title" type="text" id="title" value="<?php echo ($data["title"]); ?>" style="width:250px" /></td>
            <td width="90">&nbsp;博文作者：</td>
            <td width="200"><input name="username" type="text" id="writer" style="width:70px" value="<?php echo ($data["username"]); ?>" readonly="readonly"/>(注：无需手动添加)</td>
          </tr>
        </table></td>
    </tr>
    <tr>
      ...
      <td height="24" colspan="5" class="bline">
          ...
          <tr>
            ...
            <td width="560">
                ...
                <tr>
                  <td height="30">
                  <input name="pic" type="text" id="picid" style="width:240px" value="<?php echo ($data["pic"]); ?>"/>
    ...
    <tr>
      <td height="24" colspan="5" class="bline">
        ...
        <tr>
          <td width="90">&nbsp;博文来源：</td>
          <td width="448"><input type='text' name="source" id="sourceid" style="width:50%" value="<?php if($data['source'] == '未知'){echo '';}else{echo $data['source'];} ?>" /></td>
          <td>排序:<input name="ord" id="orderid" value="<?php echo ($data["ord"]); ?>" style="width:25px" type="text"/></td>
        </tr>
      </table></td>
    </tr>
    <tr>
      <td height="24" colspan="5" class="bline">
        ...
        <tr>
          <td width="90">&nbsp;关键字：</td>
          <td width="448"><input type='text' name="keyword" id="keywordid" style="width:95%" value="<?php echo ($data["keyword"]); ?>" /><input type="hidden" value="<?php echo ($data["iskey"]); ?>" name="iskey"/></td>
    ...
    <tr>
      ...
      <table width="800" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="90">&nbsp;内容摘要：</td>
          <td width="449"><textarea name="description" rows="5" id="descriptionid" style="width:80%;height:50px"><?php echo ($data["description"]); ?></textarea></td>
          <td width="261">&nbsp;</td>
        </tr>
      </table>
      </td>
    ...
    <tr>
      <td width="100%" id="arcBody" align="center">
       <textarea name="content" id="contentid"  style="width:950px;height:400px;" class="required" ><?php echo ($data["content"]); ?></textarea>
	    </td>
